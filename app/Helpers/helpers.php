...
if (!function_exists('view')) {
	/**
	 * Returns view file for the frontend
	 * @param  string $view view name
	 * @param  array  $data Data to pass in view from class
	 * @return void
	 */
	function view($view, $data = array(), $stopScriptAfterIncluding = false) {
		$view = dirname(__DIR__) . '/../resources/views/' . $view . '.php';
		if (file_exists($view)) {
			extract($data);
			require $view;
			if ($stopScriptAfterIncluding) {
				exit;
			}
...
if (!function_exists('app_log')) {
	...
	/**
	 * Event Logging helper (you can log an array, object or a string hmmmm lets say you can log anything)
	 * @param  array || object || string $data    Data to log
	 * @param  string $logType Log type (INFO, ERROR or you can name anything you want to.)
	 * @return void
	 */
