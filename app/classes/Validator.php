...
class Validator {
	...
	public function get_readable_errors($convert_to_string = false, $field_class = 'gump-field', $error_class = 'gump-error-message') {
		...
		foreach ($this->errors as $e) {
			...
			case 'validate_unique':
				$resp[] = "This $field has been already taken.";
				break;
			case 'validate_exist':
				$resp[] = "This $field doesn't exist.";
				break;
			default:
	...
	public function get_errors_array($convert_to_string = null) {
		...
		foreach ($this->errors as $e) {
			...
			case 'validate_min_age':
				...
				break;
			case 'validate_unique':
				$resp[$field] = "This $field has been already taken";
				break;
			case 'validate_exist':
				$resp[$field] = "This $field doesn't exist.";
				break;
			default:
	...
	*/
	...
	/**
	 * UNique record validator
	 * @param  mixed $field
	 * @param  mixed $input
	 * @param  mixed $param
	 * @return mixed        [description]
	 */
	protected function validate_unique($field, $input, $params = null) {
		...
		$check = $db->table($params[0])->where($field, $input[$field])->get();
	...
	/**
	 * Checks whether the record exist or not
	 * @param  mixed $field
	 * @param  mixed $input
	 * @param  mixed $param
	 * @return mixed        [description]
	 */
	protected function validate_exist($field, $input, $params = null) {
